...
if dataset=='ton_iot':
    ...
    benign_np , preprocess, float_cols, categorical_cols =df_to_np('csv/nf-cse-cic/nf-cse-cic-sample.csv', nf_cse_cic.datatypes,train_set=True, return_preprocess=True)
